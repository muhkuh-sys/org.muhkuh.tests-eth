...
void HALDEF(DPM_CfgDpm)( unsigned int        uiInst,
                         DPM_MODE_E          eMode,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_SetCfg0x0)( unsigned int    uiInst,
                            DPM_MODE_E      eMode,
                            DPM_ENDIANESS_E eEndianess )
{
  s_aptDpm[uiInst]->ulDpm_cfg0x0 =  ((uint32_t)eMode << HW_SRT(dpm_cfg0x0_mode))
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_SetAddrRange)( unsigned int    uiInst,
                               DPM_ADDRRANGE_E eAddrRange )
{
...
*                                                                            */
/****************************************************************************/
void HALDEF(DPM_SetCfgWinAddrCfg)( unsigned int uiInst,
    DPM_CFGWINADDRCFG_E eCfgWinAddrCfg )
{
...
*                                                                            */
/*****************************************************************************/
int HALDEF(DPM_AddrCmp)( unsigned int      uiInst,
                        ...
                        DPM_ADDRCMPCODE_E  eAddrCmpCode )
{
  ...
  /* plausibility check */
  if( (int)eAddrCmpCode > 3 ) return -1;

  switch( eAddrCmpNr )
  {
#if defined(__NETX90_MPW)
    case DPM_ADDRCCMP_A11:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a11);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a11);
    break;
    
    case DPM_ADDRCCMP_A12:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a12);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a12);
    break;

    case DPM_ADDRCCMP_A13:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a13);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a13);
    break;

    case DPM_ADDRCCMP_A14:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a14);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a14);
    break;

    case DPM_ADDRCCMP_A15:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a15);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a15);
    break;

    case DPM_ADDRCCMP_A16:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a16);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a16);
    break;

    case DPM_ADDRCCMP_A17:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a17);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a17);
    break;

    case DPM_ADDRCCMP_A18:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a18);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a18);
    break;

    case DPM_ADDRCCMP_A19:
      s_aptDpm[uiInst]->ulDpm_addr_cfg &= ~HW_MSK(dpm_addr_cfg_addr_cmp_a19);
      s_aptDpm[uiInst]->ulDpm_addr_cfg |= (uint32_t)eAddrCmpCode << HW_SRT(dpm_addr_cfg_addr_cmp_a19);
    break;
#endif
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetCfgDpm)( unsigned int uiInst,
                            uint32_t*    pulCfg0x0,
                            uint32_t*    pulAddrCfg )
{
...
int HALDEF(DPM_CfgIf)( unsigned int   uiInst,
...
*   -1 on error                                                              */
/*****************************************************************************/
int HALDEF(DPM_CfgTiming)( unsigned int uiInst,
                           unsigned int uTosa,
...
*   -1 on error                                                              */
/*****************************************************************************/
int HALDEF(DPM_CfgRdy)( unsigned int    uiInst,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_CfgPio)( unsigned int uiInst,
                         uint32_t     ulSelDPio,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetCfgPio)( unsigned int uiInst,
                            uint32_t*    pulDPio,
                            uint32_t*    pulMiscPio )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_CfgMisc)( unsigned int uiInst,
                          uint32_t     ulMiscCfg,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetCfgMisc)(unsigned int uiInst,
                            uint32_t*    pulMiscCfg,
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_CfgDpmWindow)( unsigned int uiInst,
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_SetCfgDpmWindow)( unsigned int     uiInst,
                                 unsigned int     uWinNum,
                                 uint32_t         ulSize,
                                 uint32_t         ulMapStartAddr,
                                 DPM_WINMAP_ALT_E eAltMapping )
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_GetCfgDpmWindow)( unsigned int uiInst,
                                 unsigned int uWinNum,
                                 uint32_t*    pulWinEnd,
                                 uint32_t*    pulWinMap )
{
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_SetupByteAccess)( unsigned int uiInst,
                                 unsigned int uWinNum,
                                 bool         fByteAccess )
{
  int iRslt = 0;
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_SetupReadAhead)( unsigned int uiInst,
                                unsigned int uWinNum,
                                bool         fReadAhead )
{
  int iRslt = 0;
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_SetupReadLatch)( unsigned int uiInst,
                                unsigned int uWinNum,
                                bool         fReadLatch )
{
  int iRslt = 0;
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetStatusErr)( unsigned int uiInst,
                               uint32_t*    pulStatErr,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_ClearErr)( unsigned int uiInst,
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_GetIrq)( unsigned int     uiInst,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_SetFwIrqRaw)( unsigned int uiInst,
                              uint32_t     ulFwIrqRaw )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_Reset)( unsigned int uiInst )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_SetResetRequest)( unsigned int uiInst,
                                  uint8_t      bResetKey )
{
...
/*****************************************************************************/
uint8_t HALDEF(DPM_GetResetRequest)( unsigned int uiInst )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_SetSysSta)( unsigned int uiInst,
                            uint32_t     ulSysSta )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetSysSta)( unsigned int uiInst,
                            uint32_t*    pulSysSta,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(DPM_GetNetxVersion)( unsigned int uiInst,
...
int HALDEF(DPM_CfgTunnel)( unsigned int uiInst,
...
int HALDEF(DPM_ITBAddr)( unsigned int uiInst,
                         unsigned int uMap,
                         unsigned int uBase )
{
...
/*****************************************************************************/
bool HALDEF(DPM_IrqIsPending)( unsigned int uiInst,
                               unsigned int uIrqId )
{
  if(uIrqId < 32) {
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HALDEF(DPM_SetParam)( unsigned int uiInst,
                          DPM_PRM_E    ePrmID,
                          uint32_t     ulPrmVal )
{
  int iRslt = 0;
...
/*****************************************************************************/
uint32_t HALDEF(DPM_GetParam)( unsigned int uiInst,
                               DPM_PRM_E    ePrmID )
{
  uint32_t ulRetVal = 0;
