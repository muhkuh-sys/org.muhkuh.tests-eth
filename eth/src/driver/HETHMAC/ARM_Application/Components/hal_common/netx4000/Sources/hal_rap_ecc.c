...
void     HALDEF(RAP_ECC_SetCtrl)( int iMemId, bool fEnable, uint32_t ulSyndromeInv )
{
...
*                                                                            */
/*****************************************************************************/
uint32_t HALDEF(RAP_ECC_GetErrAdr)( int iMemId, bool fDbe )
{
  uint32_t ulVal;
...
/*****************************************************************************/
uint32_t HALDEF(RAP_ECC_GetIrq)( bool fDbe )
{
  uint32_t ulIrq = 0;
...
*   Bit mask indicating the detected errors and pending IRQs                 */
/*****************************************************************************/
void     HALDEF(RAP_ECC_ConfirmIrq)( uint32_t uIrqMsk, bool fDbe )
{
  if( !fDbe )
  {
