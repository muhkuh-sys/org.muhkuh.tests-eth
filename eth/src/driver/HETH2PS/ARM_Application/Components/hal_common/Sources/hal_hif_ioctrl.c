...
*   uiEnHifRdyPioMi   [in] 1: Enable HIF_RDY for PIO usage
*   uiEnHifSdram      [in] 1: Enable HIF IOs for SDRAM memory interface configuration
* \return
*   0 on success
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HIF_IOCTRL_SetIoCfg ( HIF_IOCTRL_HIF_MI_CFG_E      eDataWidth,
                          HIF_IOCTRL_SEL_HIF_A_WIDTH_E eAddrWidth,
                          unsigned int                 uiEnHifRdyPioMi,
                          unsigned int                 uiEnHifSdram )
{
  uint32_t ulAccessKey;

  /* Plausibility check */
  if( (unsigned)eDataWidth > HIF_IOCTRL_HIF_MI_CFG_NO_MI )
    return -1;
  ...
  s_ptHifIoCtrl->ulHif_io_cfg = ((uint32_t)eDataWidth     << HW_SRT(hif_io_cfg_hif_mi_cfg))
                               ...
                               |((uint32_t)uiEnHifRdyPioMi << HW_SRT(hif_io_cfg_en_hif_rdy_pio_mi))
                               |((uint32_t)uiEnHifSdram    << HW_SRT(hif_io_cfg_en_hif_sdram_mi));
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HIF_IOCTRL_SetIoCfgReg( HIF_IOCTRL_HIF_MI_CFG_E      eDataWidth,
                            HIF_IOCTRL_SEL_HIF_A_WIDTH_E eAddrWidth,
                            unsigned int                 uiEnHifRdyPioMi,
                            unsigned int                 uiEnHifSdram,
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetIoConfig ( void )
{
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_SetIoConfig( uint32_t ulHifIoCfg )
{
  uint32_t ulAccessKey;
...
*   uiSelEnIn          [in] HIF PIO Input sampling enable select
*   uiFilterEnIn       [in] HIF PIO Input sampling enable (EN_IN) filter
...
*   uiFilterIrqs       [in] Filtering of HIF PIO inputs for IRQ generation
*   uiNetx50PioRegComp [in] netX50 HIF-PIO configuration register compatibility
* \return
*   0 on success
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HIF_IOCTRL_SetPioCfg ( HIF_IOCTRL_IN_CTRL_E     eInCtrl,
                           unsigned int             uiSelEnIn,
                           unsigned int             uiFilterEnIn,
                           ...
                           unsigned int             uiFilterIrqs,
                           unsigned int             uiNetx50PioRegComp )
{
  /* Plausibility check */
  if( (unsigned)eInCtrl>HIF_IOCTRL_IN_CTRL_PIOS_SAMPLED_EN_IN_HI )
    return -1;
  if( (unsigned)eIrqPio35Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  if( (unsigned)eIrqPio36Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  if( (unsigned)eIrqPio40Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  if( (unsigned)eIrqPio47Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  if( (unsigned)eIrqPio72Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  if( (unsigned)eIrqD12Cfg>HIF_IOCTRL_IRQ_PIO_CFG_RISING_EDGE_ACTIVE )
    return -1;
  ...
  s_ptHifIoCtrl->ulHif_pio_cfg = ((uint32_t)eInCtrl      << HW_SRT(hif_pio_cfg_in_ctrl))
                                ...
                                |((uint32_t)uiSelEnIn    << HW_SRT(hif_pio_cfg_sel_en_in))
#endif
                                |((uint32_t)uiFilterEnIn << HW_SRT(hif_pio_cfg_filter_en_in))
                                ...
                                |((uint32_t)uiFilterIrqs << HW_SRT(hif_pio_cfg_filter_irqs));
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_SetLine( unsigned int uOutRegNum,
                              uint32_t     ulVal )
{
  if( uOutRegNum<2 )
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetLine( unsigned int uOutRegNum )
{
  if( uOutRegNum>1 )
    return 0;
  else
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_SetOe( unsigned int uOeRegNum,
                            uint32_t     ulVal )
{
  if( uOeRegNum<2 )
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetOe( unsigned int uOeRegNum )
{
  if( uOeRegNum>1 )
    return 0;
  else
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetIn( unsigned int uInRegNum )
{
  if( uInRegNum>1 )
    return 0;
  else
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_IrqEnable( uint32_t ulPioNum )
{
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_IrqDisable( uint32_t ulPioNum )
{
...
/*****************************************************************************/
int HIF_IOCTRL_GetIrq( uint32_t ulPioNum )
{
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetIrqMasked( void )
{
...
*                                                                            */
/*****************************************************************************/
void HIF_IOCTRL_IrqReset( uint32_t ulPioNum )
{
...
*   -1 on erroneous                                                          */
/*****************************************************************************/
int HIF_IOCTRL_SetParam( HIF_IOCTRL_PRM_E ePrmID,
                         uint32_t         ulPrmVal )
{
  int iRslt = 0;
...
/*****************************************************************************/
uint32_t HIF_IOCTRL_GetParam( HIF_IOCTRL_PRM_E ePrmID )
{
  uint32_t ulRetVal;
