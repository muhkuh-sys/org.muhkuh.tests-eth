#ifndef _HAL_RESOURCES_DEFINES_NETX6_H
#define _HAL_RESOURCES_DEFINES_NETX6_H
...
/*** XC loader ***/
typedef int(*NX6_PFN_XC_RESET)(unsigned int uPortNo, void* pvUser);
typedef int(*NX6_PFN_XC_LOAD) (unsigned int uPortNo, NX6_XC_TYPE_E eXcType, const uint32_t* pulXcPrg, void* pvUser);
typedef int(*NX6_PFN_XC_START)(unsigned int uPortNo, void* pvUser);
...
/*** IRQ lock/unlock ***/
#define lock_irqfiq_save(x)    NX51_lock_irqfiq_save(x)
#define lock_irqfiq_restore(x) NX51_lock_irqfiq_restore(x)

#endif /* _HAL_RESOURCES_DEFINES_NETX6_H */
