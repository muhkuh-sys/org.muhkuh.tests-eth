...
{
  /* Disable the unit */
  s_aptI2c[uiInst]->ulI2c_mcr = HW_MSK(i2c_mcr_rst_i2c);
  s_aptI2c[uiInst]->ulI2c_mcr = 0;

  /* Disable slave mode */
  s_aptI2c[uiInst]->ulI2c_scr = 0;

  /* Clear the master FIFO */
  s_aptI2c[uiInst]->ulI2c_mfifo_cr = HW_MSK(i2c_mfifo_cr_mfifo_clr);
  s_aptI2c[uiInst]->ulI2c_mfifo_cr = 0;

  /* Clear the slave FIFO */
  s_aptI2c[uiInst]->ulI2c_sfifo_cr = HW_MSK(i2c_sfifo_cr_sfifo_clr);
  s_aptI2c[uiInst]->ulI2c_sfifo_cr = 0;

  /* Disable IRQs */
  s_aptI2c[uiInst]->ulI2c_irqmsk = 0;

  /* Enable DMA requests */
  s_aptI2c[uiInst]->ulI2c_dmacr = HW_MSK(i2c_dmacr_mdmab_en)
                                |HW_MSK(i2c_dmacr_mdmas_en)
                                |HW_MSK(i2c_dmacr_sdmab_en)
                                |HW_MSK(i2c_dmacr_sdmas_en);

  /* Enable I2C core */
  s_aptI2c[uiInst]->ulI2c_mcr = ((uint32_t)eSpeed << HW_SRT(i2c_mcr_mode))
...
void I2C_MStart( unsigned int uiInst, unsigned int uiSlaveAdr, unsigned int uiNumBytes, bool fRead )
{
  ...
  ulVal  = s_aptI2c[uiInst]->ulI2c_mcr;
  ulSadr = uiSlaveAdr << HW_SRT(i2c_mcr_sadr);
  if( ulSadr != (ulVal & HW_MSK(i2c_mcr_sadr)) )
  {
    /* set slave address */
    ulVal &= ~HW_MSK(i2c_mcr_sadr);
    ulVal |= ulSadr;
    s_aptI2c[uiInst]->ulI2c_mcr = ulVal;
  }
  ...
  s_aptI2c[uiInst]->ulI2c_cmd = ulVal;
}
...
int I2C_MWr( unsigned int uiInst, const uint8_t* pbData, int iMaxBytes )
{
  ...
  ulVal = s_aptI2c[uiInst]->ulI2c_sr;
  ...
  {
    s_aptI2c[uiInst]->ulI2c_mdr = pbData[iCnt];
  }
...
int I2C_MRd( unsigned int uiInst, uint8_t* pbData, int iMaxBytes )
{
  ...
  for(iCnt = 0; iCnt < iMaxBytes; ++iCnt)
  {
    ulVal = s_aptI2c[uiInst]->ulI2c_mdr;
...
{
  uint32_t ulVal = s_aptI2c[uiInst]->ulI2c_cmd;
...
{
  uint32_t ulVal = s_aptI2c[uiInst]->ulI2c_sr;
  int iRet = 0;
...
{
  s_aptI2c[uiInst]->ulI2c_cmd = (I2C_CMD_STOP << HW_SRT(i2c_cmd_cmd));
}
...
{
  I2C_RESULT_E eRslt = I2C_OKAY;

  /* Get the selected parameter */
  switch( ePrmID )
  {
    case I2C_MCR:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_mcr;         break;
    case I2C_SCR:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_scr;         break;
    case I2C_CMD:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_cmd;         break;
    case I2C_MDR:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_mdr;         break;
    case I2C_SDR:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_sdr;         break;
    case I2C_MFIFO_CR:   *pulPrmVal = s_aptI2c[uiInst]->ulI2c_mfifo_cr;    break;
    case I2C_SFIFO_CR:   *pulPrmVal = s_aptI2c[uiInst]->ulI2c_sfifo_cr;    break;
    case I2C_SR:         *pulPrmVal = s_aptI2c[uiInst]->ulI2c_sr;          break;
    case I2C_IRQMSK:     *pulPrmVal = s_aptI2c[uiInst]->ulI2c_irqmsk;      break;
    case I2C_IRQSR:      *pulPrmVal = s_aptI2c[uiInst]->ulI2c_irqsr;       break;
    case I2C_IRQMSKED:   *pulPrmVal = s_aptI2c[uiInst]->ulI2c_irqmsked;    break;
    case I2C_DMACR:      *pulPrmVal = s_aptI2c[uiInst]->ulI2c_dmacr;       break;
    case I2C_PIO:        *pulPrmVal = s_aptI2c[uiInst]->ulI2c_pio;         break;

    default: eRslt = I2C_ERR_INVAL_PARAM; break;
  }
...
I2C_RESULT_E I2C_PrmSet( unsigned int uiInst, I2C_PRM_E ePrmID, uint32_t ulPrmVal )
{
  ...
  switch( ePrmID )
  {
    case I2C_MCR:        s_aptI2c[uiInst]->ulI2c_mcr = ulPrmVal;         break;
    case I2C_SCR:        s_aptI2c[uiInst]->ulI2c_scr = ulPrmVal;         break;
    case I2C_CMD:        s_aptI2c[uiInst]->ulI2c_cmd = ulPrmVal;         break;
    case I2C_MDR:        s_aptI2c[uiInst]->ulI2c_mdr = ulPrmVal;         break;
    case I2C_SDR:        s_aptI2c[uiInst]->ulI2c_sdr = ulPrmVal;         break;
    case I2C_MFIFO_CR:   s_aptI2c[uiInst]->ulI2c_mfifo_cr = ulPrmVal;    break;
    case I2C_SFIFO_CR:   s_aptI2c[uiInst]->ulI2c_sfifo_cr = ulPrmVal;    break;
    case I2C_SR:         s_aptI2c[uiInst]->ulI2c_sr = ulPrmVal;          break;
    case I2C_IRQMSK:     s_aptI2c[uiInst]->ulI2c_irqmsk = ulPrmVal;      break;
    case I2C_IRQSR:      s_aptI2c[uiInst]->ulI2c_irqsr = ulPrmVal;       break;
    case I2C_IRQMSKED:   s_aptI2c[uiInst]->ulI2c_irqmsked = ulPrmVal;    break;
    case I2C_DMACR:      s_aptI2c[uiInst]->ulI2c_dmacr = ulPrmVal;       break;
    case I2C_PIO:        s_aptI2c[uiInst]->ulI2c_pio = ulPrmVal;         break;
