...
void HALDEF(MMIO_SetCfg)( unsigned int  uiMmio,
                          MMIO_CONFIG_E eConfig,
                          unsigned int  uiInvertOut,
                          unsigned int  uiInvertIn )
{
  HALDEF(MMIO_SetCfgReg)(uiMmio, ((uint32_t)eConfig     << HW_SRT(mmio0_cfg_mmio_sel))
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_GetCfg)( unsigned int     uiMmio,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetMode)( unsigned int     uiMmio,
                        MMIO_MODE_E eMode )
{
...
/*****************************************************************************/
unsigned int HALDEF(MMIO_GetInput)( unsigned int uiMmio )
{
...
/*****************************************************************************/
unsigned int HALDEF(MMIO_GetOutput)( unsigned int uiMmio )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetOutput)( unsigned int uiMmio,
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetCfgReg) ( unsigned int uiMmio, uint32_t ulSetCfg )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetCfgRaw) ( unsigned int uiMmio, uint32_t ulSetCfg )
{
  s_ptMmioCtrl->aulMmio_cfg[uiMmio] = ulSetCfg;
}
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_GetCfgReg) ( unsigned int uiMmio, uint32_t* pulGetCfg )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_PioOutLineCfgSet) ( uint32_t ulLine0, uint32_t ulLine1, uint32_t ulLine2, uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_PioOutLineCfgRst) ( uint32_t ulLine0, uint32_t ulLine1, uint32_t ulLine2, uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_PioOeLineCfgSet) ( uint32_t ulLine0, uint32_t ulLine1, uint32_t ulLine2, uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_PioOeLineCfgRst) ( uint32_t ulLine0, uint32_t ulLine1, uint32_t ulLine2, uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetOeLine)( uint32_t ulLine0,
                             uint32_t ulLine1,
                             uint32_t ulLine2,
                             uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_GetOeLine)( uint32_t* pulLine0,
                             uint32_t* pulLine1,
                             uint32_t* pulLine2,
                             uint32_t* pulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_SetOutLineCfg)( uint32_t ulLine0,
                                 uint32_t ulLine1,
                                 uint32_t ulLine2,
                                 uint32_t ulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_GetOutLineCfg)( uint32_t* pulLine0,
                                 uint32_t* pulLine1,
                                 uint32_t* pulLine2,
                                 uint32_t* pulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(MMIO_GetInLineStatus)( uint32_t* pulLine0,
                                   uint32_t* pulLine1,
                                   uint32_t* pulLine2,
                                   uint32_t* pulLine3 )
{
...
*                                                                            */
/*****************************************************************************/
uint32_t HALDEF(MMIO_GetInLine)( unsigned int uiLine )
{
  if( uiLine > 3 )
  {
    return 0;
