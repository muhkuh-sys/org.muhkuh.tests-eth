...
void irq_init( void )
{
  irq_setup(0, SRT_NX50_vic_int_enable_trigger_lt, sync_irq_handler);
  irq_setup(1, SRT_NX50_vic_int_enable_com0, irq_isr_com0);
  irq_setup(2, SRT_NX50_vic_int_enable_com1, irq_isr_com1);
}
