...
#define NX50_HIF_MODE_HIGHZ     0
#define NX50_HIF_MODE_EXTBUS    1
#define NX50_HIF_MODE_DPM_8BIT  2
#define NX50_HIF_MODE_DPM_16BIT 3
#define NX50_HIF_MODE_IO        4
...
int NX50_PFIFO_SetBorders(const unsigned int *auPFifoDepth);
...
#define MSK_NX50_XC_TYPE_RPU  (1U << NX50_XC_TYPE_RPU)
#define MSK_NX50_XC_TYPE_TPU  (1U << NX50_XC_TYPE_TPU)
#define MSK_NX50_XC_TYPE_XPEC (1U << NX50_XC_TYPE_XPEC)
#define MSK_NX50_XC_TYPE_XMAC (MSK_NX50_XC_TYPE_RPU  | MSK_NX50_XC_TYPE_TPU)
#define MSK_NX50_XC_TYPE_ALL  (MSK_NX50_XC_TYPE_XMAC | MSK_NX50_XC_TYPE_XPEC)
