...
# Run jonchki.
${JONCHKI_TOOL} install-dependencies --verbose DEBUG --syscfg installer/jonchki/eth_patcher/jonchkisys.cfg --prjcfg installer/jonchki/eth_patcher/jonchkicfg.xml --dependency-log installer/jonchki/eth_patcher/dependency-log.xml --logfile targets/jonchki/eth_patcher/jonchki.log --project-root . installer/jonchki/eth_patcher/eth_patcher.xml 
if [ $? -ne 0 ]; then
  exit -1
fi
