...
#define NX_XC_TYPE_RPU      NX500_XC_TYPE_RPU
#define NX_XC_TYPE_TPU      NX500_XC_TYPE_TPU
#define NX_XC_TYPE_XPEC     NX500_XC_TYPE_XPEC
#define NX_XC_TYPE_RPEC     NX500_XC_TYPE_XPEC /* alias */

#define MSK_NX_XC_TYPE_RPU  MSK_NX500_XC_TYPE_RPU
#define MSK_NX_XC_TYPE_TPU  MSK_NX500_XC_TYPE_TPU
#define MSK_NX_XC_TYPE_XMAC MSK_NX500_XC_TYPE_XMAC
#define MSK_NX_XC_TYPE_XPEC MSK_NX500_XC_TYPE_XPEC
#define MSK_NX_XC_TYPE_RPEC MSK_NX500_XC_TYPE_XPEC /* alias */
#define MSK_NX_XC_TYPE_ALL  MSK_NX500_XC_TYPE_ALL
...
/* *** XC loader *** */
typedef int(*NX500_PFN_XC_RESET)      ( unsigned int uiPort, void* pvUser );
typedef int(*NX500_PFN_XC_RESET_UNITS)( unsigned int uiPort, unsigned int uUnitVec, void* pvUser );
typedef int(*NX500_PFN_XC_LOAD)       ( unsigned int uiPort, NX500_XC_TYPE_E eXcType, unsigned long* pulXcPrg, void* pvUser );
typedef int(*NX500_PFN_XC_START)      ( unsigned int uiPort, void* pvUser );
typedef int(*NX500_PFN_XC_START_UNITS)( unsigned int uiPort, unsigned int uiUnitVec, void* pvUser );

#define __USE_XC_LOADER_FUNC_RESET       static NX500_PFN_XC_RESET       pfnXcReset      = NX500_XC_Reset;
#define __USE_XC_LOADER_FUNC_RESET_UNITS static NX500_PFN_XC_RESET_UNITS pfnXcResetUnits = NX500_XC_ResetUnits;
#define __USE_XC_LOADER_FUNC_LOAD        static NX500_PFN_XC_LOAD        pfnXcLoad       = NX500_XC_Load;
#define __USE_XC_LOADER_FUNC_START       static NX500_PFN_XC_START       pfnXcStart      = NX500_XC_Start;
#define __USE_XC_LOADER_FUNC_START_UNITS static NX500_PFN_XC_START_UNITS pfnXcStartUnits = NX500_XC_StartUnits;
