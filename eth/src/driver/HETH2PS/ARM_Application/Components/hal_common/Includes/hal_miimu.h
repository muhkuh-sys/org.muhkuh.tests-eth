...
int MIIMU_ReadPhyReg   ( unsigned int uMiimuPreamble, unsigned int uMiimuMdcFreq, unsigned int uMiimuRtaField, unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t* pusData, void* pvUser);
int MIIMU_WritePhyReg  ( unsigned int uMiimuPreamble, unsigned int uMiimuMdcFreq, unsigned int uMiimuWtaField, unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t usData, void* pvUser);
int MIIMU_ReadPhyRegSw ( unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t* pusData, void* pvUser);
int MIIMU_WritePhyRegSw( unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t usData, void* pvUser);
