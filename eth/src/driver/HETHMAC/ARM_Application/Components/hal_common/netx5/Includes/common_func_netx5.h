...
#define MSK_NX5_XC_UNIT_RPU  (1U << NX5_XC_TYPE_RPU)
#define MSK_NX5_XC_UNIT_TPU  (1U << NX5_XC_TYPE_TPU)
#define MSK_NX5_XC_UNIT_XPEC (1U << NX5_XC_TYPE_XPEC)
#define MSK_NX5_XC_UNIT_XMAC (MSK_NX5_XC_UNIT_RPU | MSK_NX5_XC_UNIT_TPU)
#define MSK_NX5_XC_UNIT_ALL  (MSK_NX5_XC_UNIT_XMAC | MSK_NX5_XC_UNIT_XPEC)
...
#define NX5_INT_PHY1_ADDR     	                0x02
#define NX5_INT_PHY2_ADDR     	                0x03
