...
typedef void (*PFN_NETWORK_IF_SEND_PACKET)(void *pvPacket, unsigned int sizPacket, void *pvUser);
typedef void *(*PFN_NETWORK_IF_GET_RECEIVED_PACKET)(unsigned int *psizPacket, void *pvUser);
