/****************************************************************************************************
	...
	Version			: $Revision: 1 $
	Description		: register-definition for emsys-usb-core

	Compiler		: 
	HW-Env.			: 

	Author(s)		: 
	Company(s)		: emsys GmbH; D-98693 Ilmenau; Ehrenbergstrasse 11

	Known bugs		: 

	Restrictions	: 

	Last update		: $Date: 26.07.06 11:29 $

	History			:
					  $Log: /netx_support/Examples/Hardware/General/USB-CDC/Includes/regmap.h $
 * 
 * 1     26.07.06 11:29 Andreasj
					  Revision 1.2  2004/06/22 13:03:05  proto
					  *** empty log message ***
					
					  Revision 1.1  2004/05/17 06:49:46  stefan
					  -initial version
					

****************************************************************************************************/

#ifndef __EMSYS_USB_OTGDRD_DEF_FIRST__
#define __EMSYS_USB_OTGDRD_DEF_FIRST__
