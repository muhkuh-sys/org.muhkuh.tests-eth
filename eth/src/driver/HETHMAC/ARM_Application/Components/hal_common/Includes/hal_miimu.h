#ifndef __HAL_MIIMU_H
#define __HAL_MIIMU_H
...
int HALDEC(MIIMU_ReadPhyReg)   ( unsigned int uMiimuPreamble, unsigned int uMiimuMdcFreq, unsigned int uMiimuRtaField, unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t* pusData, void* pvUser);
int HALDEC(MIIMU_WritePhyReg)  ( unsigned int uMiimuPreamble, unsigned int uMiimuMdcFreq, unsigned int uMiimuWtaField, unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t usData, void* pvUser);
int HALDEC(MIIMU_ReadPhyRegSw) ( unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t* pusData, void* pvUser);
int HALDEC(MIIMU_WritePhyRegSw)( unsigned int uMiimuPhyAddr, unsigned int uMiimuReqAddr, uint16_t usData, void* pvUser);


#endif /* #ifndef __HAL_MIIMU_H */
