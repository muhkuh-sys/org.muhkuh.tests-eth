...
void HALDEF(GTimer_Start)( uint64_t ulStartVal )
{
...
*   timer value                                                              */
/*****************************************************************************/
uint64_t HALDEF(GTimer_GetTimer)( void )
{
  uint32_t ulValHi;
  uint32_t ulValLo;
  uint64_t ullVal;
...
void HALDEF(GTimer_StartCmp) ( uint64_t ullCmpVal, uint32_t ulAutoInc )
{
...
void HALDEF(GTimer_StopCmp) ( void )
{
...
*   Interrupt bit mask                                                       */
/*****************************************************************************/
uint32_t HALDEF(GTimer_GetIrqRaw)( void )
{
...
/*****************************************************************************/
void HALDEF(GTimer_CnfIrq)( uint32_t ulIrq )
{
