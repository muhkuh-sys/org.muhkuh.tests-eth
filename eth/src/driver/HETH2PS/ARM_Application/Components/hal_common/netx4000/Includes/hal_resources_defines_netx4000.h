...
#define MSK_NX_XC_TYPE_XMAC MSK_XC_TYPE_XMAC
#define MSK_NX_XC_TYPE_RPEC MSK_XC_TYPE_RPEC
#define MSK_NX_XC_TYPE_TPEC MSK_XC_TYPE_TPEC
#define MSK_NX_XC_TYPE_XPEC MSK_XC_TYPE_XPEC
#define MSK_NX_XC_TYPE_ALL  MSK_XC_TYPE_ALL
...
#define __USE_MCP               static NX4000_HS_IRQ_REG_AREA_T*          const s_ptMcp = (NX4000_HS_IRQ_REG_AREA_T*) Addr_NX4000_cr7_multi_cpu_ping_irq;
...
#define __USE_MIIMU_FUNC_READ_PHY  static NX4000_PFN_MIIMU_READ_PHY_REG  pfnMiimuReadPhyReg  = MIIMU_ReadPhyReg;
#define __USE_MIIMU_FUNC_WRITE_PHY static NX4000_PFN_MIIMU_WRITE_PHY_REG pfnMiimuWritePhyReg = MIIMU_WritePhyReg;

/*** XC loader ***/
typedef int(*NX4000_PFN_XC_RESET)      ( unsigned int uiXcInst, unsigned int uiXcPort, void* pvUser);
typedef int(*NX4000_PFN_XC_LOAD)       ( unsigned int uiXcInst, unsigned int uiXcPort, XC_TYPE_E eXcType, const uint32_t* pulXcPrg, void* pvUser );
typedef int(*NX4000_PFN_XC_START)      ( unsigned int uiXcInst, unsigned int uiXcPort, void* pvUser);
typedef int(*NX4000_PFN_XC_START_UNITS)( unsigned int uiXcInst, unsigned int uiXcPort, unsigned int uiUnitVec, void* pvUser );

#ifdef DISABLE_XC_RESET
#define __USE_XC_LOADER_FUNC_RESET        static NX4000_PFN_XC_RESET       pfnXcReset      = XC_ResetDummy;
#else
#define __USE_XC_LOADER_FUNC_RESET        static NX4000_PFN_XC_RESET       pfnXcReset      = XC_Reset;
#endif
#define __USE_XC_LOADER_FUNC_LOAD         static NX4000_PFN_XC_LOAD        pfnXcLoad       = XC_Load;
#define __USE_XC_LOADER_FUNC_START        static NX4000_PFN_XC_START       pfnXcStart      = XC_Start;
#define __USE_XC_LOADER_FUNC_START_UNITS  static NX4000_PFN_XC_START_UNITS pfnXcStartUnits = XC_StartUnits;
...
#define __USE_XPIC_LOADER_FUNC_RESET static NX4000_PFN_XPIC_RESET pfnXpicReset = XPIC_Reset;
#define __USE_XPIC_LOADER_FUNC_LOAD  static NX4000_PFN_XPIC_LOAD  pfnXpicLoad  = XPIC_Load;
#define __USE_XPIC_LOADER_FUNC_START static NX4000_PFN_XPIC_START pfnXpicStart = XPIC_Start;
