...
/*** XC loader ***/
typedef int(*PFN_XC_RESET)      ( unsigned int uiXcInst, unsigned int uiXcPort, void* pvUser);
typedef int(*PFN_XC_LOAD)       ( unsigned int uiXcInst, unsigned int uiXcPort, XC_TYPE_E eXcType, const uint32_t* pulXcPrg, void* pvUser );
typedef int(*PFN_XC_START)      ( unsigned int uiXcInst, unsigned int uiXcPort, void* pvUser);
typedef int(*PFN_XC_START_UNITS)( unsigned int uiXcInst, unsigned int uiXcPort, unsigned int uiUnitVec, void* pvUser );
