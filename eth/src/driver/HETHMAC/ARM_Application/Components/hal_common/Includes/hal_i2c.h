...
I2C_RESULT_E        HALDEC(I2C_Init)( unsigned int uInst, I2C_SPEED_E eSpeed );

void                HALDEC(I2C_MStart)( unsigned int uInst, unsigned int uSlaveAdr, unsigned int uiNumBytes, bool fRead );
int                 HALDEC(I2C_MWr)( unsigned int uInst, const uint8_t* pbData, int iMaxBytes );
int                 HALDEC(I2C_MRd)( unsigned int uInst, uint8_t* pbData, int iMaxBytes );
bool                HALDEC(I2C_MIsBusy)( unsigned int uInst );
void                HALDEC(I2C_MStop)( unsigned int uInst );

int                 HALDEC(I2C_GetStatus)( unsigned int uInst );

I2C_RESULT_E        HALDEC(I2C_PrmGet)( unsigned int uInst, I2C_PRM_E ePrmID, uint32_t* pulPrmVal );
I2C_RESULT_E        HALDEC(I2C_PrmSet)( unsigned int uInst, I2C_PRM_E ePrmID, uint32_t ulPrmVal );
