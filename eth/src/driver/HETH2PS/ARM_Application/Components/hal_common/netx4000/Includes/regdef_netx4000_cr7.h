...
#ifndef __regdef_netx4000_cr7_h__
#define __regdef_netx4000_cr7_h__
...
enum {
  ...
  BFW_NX4000_scu_ctrl_ram_ecc_en              = 1,  /* [2] */
  ...
  BFW_NX4000_scu_ctrl_res1                    = 5,  /* [11:7] */
  BFW_NX4000_scu_ctrl_ecc_check_en_m0         = 1,  /* [12] */
  BFW_NX4000_scu_ctrl_ecc_check_en_m1         = 1,  /* [13] */
  BFW_NX4000_scu_ctrl_ecc_check_en_mp         = 1,  /* [14] */
  BFW_NX4000_scu_ctrl_ecc_check_en_acp        = 1,  /* [15] */
  BFW_NX4000_scu_ctrl_res2                    = 16  /* [31:16] */
};
...
typedef struct NX4000_SCU_CTRL_BIT_Ttag {
  ...
  unsigned int ram_ecc_en              : BFW_NX4000_scu_ctrl_ram_ecc_en;              /* Enables ECC                                                              */
                                                                                      /* 0: ECC off. This is the default setting                                  */
                                                                                      /* 1: ECC on                                                                */
  ...
  unsigned int force_dev_port0_en      : BFW_NX4000_scu_ctrl_force_dev_port0_en;      /* reserved on CR7                                                          */
  ...
  unsigned int res1                    : BFW_NX4000_scu_ctrl_res1;                    /* Reserved, always set to zero                                             */
  unsigned int ecc_check_en_m0         : BFW_NX4000_scu_ctrl_ecc_check_en_m0;         /* When set, enables ECC check on AXI master port 0                         */
  unsigned int ecc_check_en_m1         : BFW_NX4000_scu_ctrl_ecc_check_en_m1;         /* When set, enables ECC check on AXI master port 1                         */
  unsigned int ecc_check_en_mp         : BFW_NX4000_scu_ctrl_ecc_check_en_mp;         /* When set, enables ECC check on AXI master peripheral port 0              */
  unsigned int ecc_check_en_acp        : BFW_NX4000_scu_ctrl_ecc_check_en_acp;        /* When set, enables ECC check on Accelerator Coherency Port (ACP)          */
  unsigned int res2                    : BFW_NX4000_scu_ctrl_res2;                    /* Reserved, always set to zero                                             */
...
enum {
  BFW_NX4000_scu_cfg_number_of_processors = 1,  /* [0] */
  BFW_NX4000_scu_cfg_res0                 = 3,  /* [3:1] */
  BFW_NX4000_scu_cfg_p0_coherency_mode    = 1,  /* [4] */
  BFW_NX4000_scu_cfg_res1                 = 3,  /* [7:5] */
  BFW_NX4000_scu_cfg_p0_cache_size        = 4,  /* [11:8] */
  BFW_NX4000_scu_cfg_res2                 = 20  /* [31:12] */
};

typedef struct NX4000_SCU_CFG_BIT_Ttag {
  unsigned int number_of_processors : BFW_NX4000_scu_cfg_number_of_processors; /* Number of processors present in the Cortex-R7 MPCore processor: */
                                                                               /* 0: One Cortex-R7 processor, processor 0.                        */
                                                                               /* 1: Two Cortex-R7 processors, processor 0 and processor 1.       */
  unsigned int res0                 : BFW_NX4000_scu_cfg_res0;                 /* Reserved                                                        */
  unsigned int p0_coherency_mode    : BFW_NX4000_scu_cfg_p0_coherency_mode;    /* Shows the coherency mode of Cortex-R7 processor 0:              */
                                                                               /* 0: Asymmetric Multi-Processing (AMP)                            */
                                                                               /* 1: Symmetric Multi-Processing (SMP)                             */
  unsigned int res1                 : BFW_NX4000_scu_cfg_res1;                 /* Reserved                                                        */
  unsigned int p0_cache_size        : BFW_NX4000_scu_cfg_p0_cache_size;        /* Cache size for processor 0: 2KB * 2 ^ p0_cache_size             */
                                                                               /* netX4000: 32KB for each I- & D-Cache                            */
...
enum {
  ...
  BFW_NX4000_scu_cpu_power_stat_res           = 30  /* [31:2] */
};
...
typedef struct NX4000_SCU_CPU_POWER_STAT_BIT_Ttag {
  ...
  unsigned int res           : BFW_NX4000_scu_cpu_power_stat_res;           /* Reserved, always set to zero              */
...
enum {
  ...
  BFW_NX4000_scu_invalidate_all_res     = 28  /* [31:4] */
};
...
enum {
  BFW_NX4000_scu_pripheral_filter_start_res     = 20, /* [19:0] */
  BFW_NX4000_scu_pripheral_filter_start_address = 12  /* [31:20] */
};

typedef struct NX4000_SCU_PRIPHERAL_FILTER_START_BIT_Ttag {
  unsigned int res     : BFW_NX4000_scu_pripheral_filter_start_res;     /* Reserved, always set to zero                        */
  unsigned int address : BFW_NX4000_scu_pripheral_filter_start_address; /* Filtering start address a one megabyte granularity. */
} NX4000_SCU_PRIPHERAL_FILTER_START_BIT_T;

typedef union {
  uint32_t                                val;
  NX4000_SCU_PRIPHERAL_FILTER_START_BIT_T bf;
} NX4000_SCU_PRIPHERAL_FILTER_START_T;
...
enum {
  BFW_NX4000_scu_pripheral_filter_end_res     = 20, /* [19:0] */
  BFW_NX4000_scu_pripheral_filter_end_address = 12  /* [31:20] */
};

typedef struct NX4000_SCU_PRIPHERAL_FILTER_END_BIT_Ttag {
  unsigned int res     : BFW_NX4000_scu_pripheral_filter_end_res;     /* Reserved, always set to zero             */
  unsigned int address : BFW_NX4000_scu_pripheral_filter_end_address; /* End address for use with peripheral port */
} NX4000_SCU_PRIPHERAL_FILTER_END_BIT_T;

typedef union {
  uint32_t                              val;
  NX4000_SCU_PRIPHERAL_FILTER_END_BIT_T bf;
} NX4000_SCU_PRIPHERAL_FILTER_END_T;
...
enum {
  ...
  BFW_NX4000_scu_access_ctrl_res          = 31  /* [31:1] */
};
...
enum {
  BFW_NX4000_scu_err_bank_entry0_status  = 2,  /* [1:0] */
  BFW_NX4000_scu_err_bank_entry0_res0    = 3,  /* [4:2] */
  BFW_NX4000_scu_err_bank_entry0_index   = 9,  /* [13:5] */
  BFW_NX4000_scu_err_bank_entry0_res1    = 2,  /* [15:14] */
  BFW_NX4000_scu_err_bank_entry0_p0_ways = 4,  /* [19:16] */
  BFW_NX4000_scu_err_bank_entry0_res2    = 12  /* [31:20] */
};

typedef struct NX4000_SCU_ERR_BANK_ENTRY0_BIT_Ttag {
  unsigned int status  : BFW_NX4000_scu_err_bank_entry0_status;  /* Error status. The values are:                               */
                                                                 /* 00: No error                                                */
                                                                 /* 01: Error seen by SCU tag RAM, but not handled by processor */
                                                                 /* 10: Error seen by both SCU and processor                    */
                                                                 /* 11: Error is confirmed by software.                         */
  unsigned int res0    : BFW_NX4000_scu_err_bank_entry0_res0;    /* Reserved, always set to zero                                */
  unsigned int index   : BFW_NX4000_scu_err_bank_entry0_index;   /* Index in the SCU tag RAM                                    */
  unsigned int res1    : BFW_NX4000_scu_err_bank_entry0_res1;    /* Reserved, always set to zero                                */
  unsigned int p0_ways : BFW_NX4000_scu_err_bank_entry0_p0_ways; /* Ways in the SCU tag ram                                     */
  unsigned int res2    : BFW_NX4000_scu_err_bank_entry0_res2;    /* Reserved, always set to zero                                */
} NX4000_SCU_ERR_BANK_ENTRY0_BIT_T;

typedef union {
  uint32_t                         val;
  NX4000_SCU_ERR_BANK_ENTRY0_BIT_T bf;
} NX4000_SCU_ERR_BANK_ENTRY0_T;
...
enum {
  BFW_NX4000_scu_err_bank_entry1_status  = 2,  /* [1:0] */
  BFW_NX4000_scu_err_bank_entry1_res0    = 3,  /* [4:2] */
  BFW_NX4000_scu_err_bank_entry1_index   = 9,  /* [13:5] */
  BFW_NX4000_scu_err_bank_entry1_res1    = 2,  /* [15:14] */
  BFW_NX4000_scu_err_bank_entry1_p0_ways = 4,  /* [19:16] */
  BFW_NX4000_scu_err_bank_entry1_res2    = 12  /* [31:20] */
};

typedef struct NX4000_SCU_ERR_BANK_ENTRY1_BIT_Ttag {
  unsigned int status  : BFW_NX4000_scu_err_bank_entry1_status;  /* Error status. The values are:                               */
                                                                 /* 00: No error                                                */
                                                                 /* 01: Error seen by SCU tag RAM, but not handled by processor */
                                                                 /* 10: Error seen by both SCU and processor                    */
                                                                 /* 11: Error is confirmed by software.                         */
  unsigned int res0    : BFW_NX4000_scu_err_bank_entry1_res0;    /* Reserved, always set to zero                                */
  unsigned int index   : BFW_NX4000_scu_err_bank_entry1_index;   /* Index in the SCU tag RAM                                    */
  unsigned int res1    : BFW_NX4000_scu_err_bank_entry1_res1;    /* Reserved, always set to zero                                */
  unsigned int p0_ways : BFW_NX4000_scu_err_bank_entry1_p0_ways; /* Ways in the SCU tag ram                                     */
  unsigned int res2    : BFW_NX4000_scu_err_bank_entry1_res2;    /* Reserved, always set to zero                                */
} NX4000_SCU_ERR_BANK_ENTRY1_BIT_T;

typedef union {
  uint32_t                         val;
  NX4000_SCU_ERR_BANK_ENTRY1_BIT_T bf;
} NX4000_SCU_ERR_BANK_ENTRY1_T;
...
enum {
  BFW_NX4000_scu_dtr_op_val = 32  /* [31:0] */
};

typedef struct NX4000_SCU_DTR_OP_BIT_Ttag {
  unsigned int val : BFW_NX4000_scu_dtr_op_val; /* value */
} NX4000_SCU_DTR_OP_BIT_T;

typedef union {
  uint32_t                val;
  NX4000_SCU_DTR_OP_BIT_T bf;
} NX4000_SCU_DTR_OP_T;
...
enum {
  BFW_NX4000_scu_dtr_val_val = 32  /* [31:0] */
};

typedef struct NX4000_SCU_DTR_VAL_BIT_Ttag {
  unsigned int val : BFW_NX4000_scu_dtr_val_val; /* value */
} NX4000_SCU_DTR_VAL_BIT_T;

typedef union {
  uint32_t                 val;
  NX4000_SCU_DTR_VAL_BIT_T bf;
} NX4000_SCU_DTR_VAL_T;
...
enum {
  BFW_NX4000_scu_dtr_ecc_chunk_val = 32  /* [31:0] */
};

typedef struct NX4000_SCU_DTR_ECC_CHUNK_BIT_Ttag {
  unsigned int val : BFW_NX4000_scu_dtr_ecc_chunk_val; /* value */
} NX4000_SCU_DTR_ECC_CHUNK_BIT_T;

typedef union {
  uint32_t                       val;
  NX4000_SCU_DTR_ECC_CHUNK_BIT_T bf;
} NX4000_SCU_DTR_ECC_CHUNK_T;
...
enum {
  BFW_NX4000_icci_ctrl_enable    = 1,  /* [0] */
  BFW_NX4000_icci_ctrl_reserved1 = 31  /* [31:1] */
};

typedef struct NX4000_ICCI_CTRL_BIT_Ttag {
  unsigned int enable    : BFW_NX4000_icci_ctrl_enable;    /* Global enable for the signalling of interrupts by the CPU interfaces to the connected processors. */
                                                           /* 0: Disable signalling of interrupts.                                                              */
                                                           /* 1: Enable signalling of interrupts.                                                               */
                                                           /* On a GIC that implements the Security Extensions, this bit controls only the signalling of        */
...
enum {
  BFW_NX4000_icd_ctrl_icd_en = 1,  /* [0] */
  BFW_NX4000_icd_ctrl_res    = 31  /* [31:1] */
};

typedef struct NX4000_ICD_CTRL_BIT_Ttag {
  unsigned int icd_en : BFW_NX4000_icd_ctrl_icd_en; /* Enable                                                                  */
                                                    /* 0: Disables all interrupt control bits in the distributor from          */
                                                    /*    changing state because of any external stimulus change that          */
                                                    /*    occurs on the corresponding SPI or PPI signals.                      */
                                                    /* 1: Enables the distributor to update register locations for interrupts. */
...
enum {
  ...
  BFW_NX4000_icd_ic_type_res             = 24  /* [31:8] */
};
...
typedef struct NX4000_ICD_IC_TYPE_BIT_Ttag {
  ...
  unsigned int cpu_number      : BFW_NX4000_icd_ic_type_cpu_number;      /* Number of processors supported:                                 */
                                                                         /* 0: The configuration contains one Cortex-R7 processor.          */
                                                                         /* 1: The configuration contains two Cortex-R7 processors.         */
  unsigned int res             : BFW_NX4000_icd_ic_type_res;             /* Reserved                                                        */
