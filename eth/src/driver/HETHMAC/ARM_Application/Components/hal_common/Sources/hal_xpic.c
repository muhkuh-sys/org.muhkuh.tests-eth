...
static void XPIC_LoadSegments( unsigned int uiXpicNo, const uint32_t *pulData )
{
...
void HALDEF(XPIC_Load)( unsigned int uiXpicNo, const uint32_t *xpic_code, void* pvUser )
{
  ...
  if( ( xpic_code[0] == 0 ) && ( xpic_code[1] == 0 ) ) {
    ...
    XPIC_LoadSegments(uiXpicNo, xpic_code);
  } else {
...
*                                                                            */
/*****************************************************************************/
void HALDEF(XPIC_Start)( unsigned int uiXpicNo, void* pvUser )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(XPIC_Stop)( unsigned int uiXpicNo, void* pvUser )
{
...
*                                                                            */
/*****************************************************************************/
void HALDEF(XPIC_Reset)( unsigned int uiXpicNo, void* pvUser )
{
  uint32_t ulVal;
...
*   raw register value                                                       */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetLastPc)( unsigned int uiXpicNo )
{
...
*   raw register value                                                       */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetBreakStatus)( unsigned int uiXpicNo )
{
...
*   raw register value                                                       */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetBreakIrqRaw)( unsigned int uiXpicNo )
{
...
/*****************************************************************************/
void HALDEF(XPIC_ConfirmBreakIrq)( unsigned int uiXpicNo, uint32_t ulIrq )
{
...
*   raw register value                                                       */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetBreakIrq)( unsigned int uiXpicNo, bool fOwn )
{
...
/*****************************************************************************/
void HALDEF(XPIC_EnableBreakIrq)( unsigned int uiXpicNo, uint32_t ulIrq, bool fOwn )
{
  if( fOwn )
...
/*****************************************************************************/
void HALDEF(XPIC_DisableBreakIrq)( unsigned int uiXpicNo, uint32_t ulIrq, bool fOwn )
{
  if( fOwn )
...
/*****************************************************************************/
void HALDEF(XPIC_SetupWatchPoint)( unsigned int uiXpicNo, unsigned int uWpNo, XPIC_WATCHPOINT_T* ptWp )
{
  if( ptWp == NULL )
  {
    /* disable watchpoint */
...
/*****************************************************************************/
void HALDEF(XPIC_StartEx)( unsigned int uiXpicNo, bool fSingleStep, bool fMonitorMode, bool fIntDis, bool fMisalignHold, void* pvUser )
{
  uint32_t ulVal = 0;
...
/*****************************************************************************/
void HALDEF(XPIC_SetBankSelect)( unsigned int uiXpicNo, bool fSel, bool fFiqBank )
{
  uint32_t ulValue = 0;
...
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetReg)( unsigned int uiXpicNo, XPIC_REG_E eReg )
{
...
/*****************************************************************************/
void HALDEF(XPIC_SetReg)( unsigned int uiXpicNo, XPIC_REG_E eReg, uint32_t ulValue )
{
...
*   XPIC                                                                     */ 
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetIrqStatus)( unsigned int uiXpicNo )
{
...
*   XPIC                                                                     */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetIrqReturnPc)( unsigned int uiXpicNo )
{
...
*   XPIC                                                                     */
/*****************************************************************************/
uint32_t HALDEF(XPIC_GetFiqReturnPc)( unsigned int uiXpicNo )
{
...
*   ulValue              [in]  Value                                         */
/*****************************************************************************/
void HALDEF(XPIC_WrDramDw)( unsigned int uiXpicNo, unsigned int uiOffset, uint32_t ulValue )
{
...
*   Read value                                                               */
/*****************************************************************************/
uint32_t HALDEF(XPIC_RdDramDw)( unsigned int uiXpicNo, unsigned int uiOffset )
{
...
*   ulValue              [in]  Value                                         */
/*****************************************************************************/
void HALDEF(XPIC_WrPramDw)( unsigned int uiXpicNo, unsigned int uiOffset, uint32_t ulValue )
{
...
*   Read value                                                               */
/*****************************************************************************/
uint32_t HALDEF(XPIC_RdPramDw)( unsigned int uiXpicNo, unsigned int uiOffset )
{
