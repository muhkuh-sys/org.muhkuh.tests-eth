...
CANCTRL_RESULT        HALDEC(CanCtrl_EnterResetMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_LeaveResetMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_EnterListenMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_LeaveListenMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_EnterSelftestMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_LeaveSelftestMode)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_SetBaudrate)( unsigned int uiInst, uint32_t ulBaudrate, unsigned int uOversampling );
CANCTRL_RESULT        HALDEC(CanCtrl_SetSingleAcceptanceFilter)( unsigned int uiInst, CANCTRL_SINGLEFILTER_T* ptFilter );
CANCTRL_RESULT        HALDEC(CanCtrl_GetSingleAcceptanceFilter)( unsigned int uiInst, CANCTRL_SINGLEFILTER_T* ptFilter );
CANCTRL_RESULT        HALDEC(CanCtrl_SetDualAcceptanceFilter)( unsigned int uiInst, CANCTRL_DUALFILTER_T* ptFilter );
CANCTRL_RESULT        HALDEC(CanCtrl_GetDualAcceptanceFilter)( unsigned int uiInst, CANCTRL_DUALFILTER_T* ptFilter );
CANCTRL_RESULT        HALDEC(CanCtrl_SendMessage)( unsigned int uiInst, CANCTRL_MESSAGE_T* ptMessage, bool fSingleShot, bool fSelfRx );
CANCTRL_RESULT        HALDEC(CanCtrl_AbortMessage)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_ReceiveMessage)( unsigned int uiInst, CANCTRL_MESSAGE_T* ptMessage );
...
CANCTRL_RESULT        HALDEC(CanCtrl_SetIrqMask)( unsigned int uiInst, uint32_t ulIrqMask );
...
CANCTRL_RESULT        HALDEC(CanCtrl_SetWarningLimit)( unsigned int uiInst, uint32_t ulLimit );
uint32_t              HALDEC(CanCtrl_GetWarningLimit)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_SetRxErrorCnt)( unsigned int uiInst, uint32_t ulCnt );
uint32_t              HALDEC(CanCtrl_GetRxErrorCnt)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_SetTxErrorCnt)( unsigned int uiInst, uint32_t ulCnt );
uint32_t              HALDEC(CanCtrl_GetTxErrorCnt)( unsigned int uiInst );
CANCTRL_RESULT        HALDEC(CanCtrl_SetPrm)( unsigned int uiInst, CANCTRL_PRM_E ePrmID, uint32_t ulPrmVal );
CANCTRL_RESULT        HALDEC(CanCtrl_GetPrm)( unsigned int uiInst, CANCTRL_PRM_E ePrmID, uint32_t* pulPrmVal );
