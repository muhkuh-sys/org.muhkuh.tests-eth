...
#if 0
/*** XC loader ***/
typedef int(*HW_PFN_XC_RESET)( unsigned int uXcNo, unsigned int uXcPortNo, void* pvUser);
typedef int(*HW_PFN_XC_LOAD) ( unsigned int uXcNo, unsigned int uXcPortNo, XC_TYPE_E eXcType, const uint32_t* pulXcPrg, void* pvUser );
typedef int(*HW_PFN_XC_START)( unsigned int uXcNo, unsigned int uXcPortNo, void* pvUser);

#define HW_PTR_XC_LOADER_FUNC_RESET(var) HW_PFN_XC_RESET var = NX4000_XC_Reset;
#define HW_PTR_XC_LOADER_FUNC_LOAD(var)  HW_PFN_XC_LOAD  var = NX4000_XC_Load;
#define HW_PTR_XC_LOADER_FUNC_START(var) HW_PFN_XC_START var = NX4000_XC_Start;

/*** xPIC loader ***/
typedef void(*HW_PFN_XPIC_RESET)(unsigned int uInstNo, void* pvUser);
typedef void(*HW_PFN_XPIC_LOAD) (unsigned int uInstNo, const uint32_t* pulXpicPrg, void* pvUser);
typedef void(*HW_PFN_XPIC_START)(unsigned int uInstNo, void* pvUser);

#define HW_PTR_XPIC_LOADER_FUNC_RESET(var)  HW_PFN_XPIC_RESET var = NX4000_XPIC_Reset;
#define HW_PTR_XPIC_LOADER_FUNC_LOAD(var)   HW_PFN_XPIC_LOAD  var = NX4000_XPIC_Load;
#define HW_PTR_XPIC_LOADER_FUNC_START(var)  HW_PFN_XPIC_START var = NX4000_XPIC_Start;
#endif
