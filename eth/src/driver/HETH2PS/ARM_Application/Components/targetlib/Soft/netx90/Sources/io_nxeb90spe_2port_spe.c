...
static uint32_t const s_aulPadCtrlTable[] =
{
  ...
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_D14,   0, PADCTRL_DS_4MA, PADCTRL_PE_NONE),   /* MII0.COL muxed to HIF_D14 with sel_extphy */
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_D15,   0, PADCTRL_DS_4MA, PADCTRL_PE_NONE),   /* MII0.CRS muxed to HIF_D15 with sel_extphy */
  ...
  PADCTRL_CFG(PAD_CTRL_PORT_MII0_RXDV, 1, PADCTRL_DS_4MA, PADCTRL_PE_PD50K),
  PADCTRL_CFG(PAD_CTRL_PORT_MII0_RXCLK,1, PADCTRL_DS_4MA, PADCTRL_PE_PD50K),
  PADCTRL_CFG(PAD_CTRL_PORT_MII0_RXER, 1, PADCTRL_DS_4MA, PADCTRL_PE_PD50K),
  PADCTRL_CFG(PAD_CTRL_PORT_MII0_TXCLK,1, PADCTRL_DS_4MA, PADCTRL_PE_PD50K),
  ...
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_D13,   1, PADCTRL_DS_8MA, PADCTRL_PE_NONE),   /* MII0.TX_EN muxed to HIF_D13 with sel_extphy */
                                                                              /* Activate IE of MII0.TX_EN to feed this signal */
  ...
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_WRN,   0, PADCTRL_DS_8MA, PADCTRL_PE_NONE),   /* SD_WE_N */
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_RDY,   0, PADCTRL_DS_8MA, PADCTRL_PE_NONE),   /* SD_CKE */
  PADCTRL_CFG(PAD_CTRL_PORT_HIF_SDCLK, 0, PADCTRL_DS_8MA, PADCTRL_PE_NONE),   /* SD_CLK */
...
void io_init(void)
{
  ...
  /* Map MLED2 to PHY LEDs of port 0, but only led1 (activity). LED0 (link status) is controlled
  ...
  MLEDCTRL_ConfigureOutput(0, 5, MLED_CTRL_SEL_LINE_REGISTER, false, MLED_CTRL_BRIGHTNESS_MAX);
  ...
  /* Connect xC1 to external PHY1, no TX_ER */
  AsicCtrl_SetIoConfig(2, BF(io_config1_sel_xm1_mii_cfg, 5)       /* Select full MII1 with RX_ER  */
                        | BF(io_config1_sel_xc1_mdio, 0b01));     /* Connect MDIO of xC1 to external MII_MDIO  */

  /* Connect xC0 to external PHY0, no TX_ER */
  AsicCtrl_SetIoConfig(1, BF(io_config0_sel_xm0_mii_cfg, 5));     /* Select full MII0 with RX_ER */
  ...
  /* Only low-active LINK LED is connected, activity is generated via software LED module */
