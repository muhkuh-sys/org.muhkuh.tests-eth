...
*   void                                                                     */
/*****************************************************************************/
void AsicCtrl_EnFirewallIrq( unsigned int uiFwIdx,
                             unsigned int uiEnVector )
{
  ASICCTRL_FIREWALLS_T* ptFw = (ASICCTRL_FIREWALLS_T*)&ASICCTRL_FIREWALL_FIRST;

  if( uiFwIdx < ASICCTRL_FIREWALL_CNT )
  {
    uint32_t ulVal = ptFw->aulFirewall_cfg[uiFwIdx];
    ...
    ulVal |= (uiEnVector << HW_SRT(firewall_cfg_netx_ram0_irq_en_cr7));
...
*   void                                                                     */
/*****************************************************************************/
void AsicCtrl_DisFirewallIrq( unsigned int uiFwIdx,
                              unsigned int uiDisVector )
{
  ASICCTRL_FIREWALLS_T* ptFw = (ASICCTRL_FIREWALLS_T*)&ASICCTRL_FIREWALL_FIRST;
  ...
  if( uiFwIdx < ASICCTRL_FIREWALL_CNT )
  {
    ...
    ulVal &= ~(uiDisVector << HW_SRT(firewall_cfg_netx_ram0_irq_en_cr7));
...
unsigned int AsicCtrl_GetFirewallIrqRaw( unsigned int uiFwIdx )
{
  ...
  if( uiFwIdx < ASICCTRL_FIREWALL_CNT )
  {
    ...
    uiIrq = (ulVal >> HW_SRT(firewall_cfg_netx_ram0_stat_cr7)) & 0xf;
  }
...
*   unsigned int                                                             */
/*****************************************************************************/
void AsicCtrl_ConfirmFirewallIrq( unsigned int uiFwIdx,
