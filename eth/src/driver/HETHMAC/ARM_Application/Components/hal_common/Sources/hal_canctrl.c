...
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_EnterResetMode)( unsigned int uiInst )
{
...
*   CANCTRL_RESULT_INVAL_PARAM                                               */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_LeaveResetMode)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetBaudrate)( unsigned int uiInst, uint32_t ulBaudrate, unsigned int uOversampling )
{
  ...
  default: return CANCTRL_RESULT_INVAL_PARAM; break;
  }
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetSingleAcceptanceFilter)( unsigned int uiInst, CANCTRL_SINGLEFILTER_T* ptFilter )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_GetSingleAcceptanceFilter)( unsigned int uiInst, CANCTRL_SINGLEFILTER_T* ptFilter )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetDualAcceptanceFilter)( unsigned int uiInst, CANCTRL_DUALFILTER_T* ptFilter )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_GetDualAcceptanceFilter)( unsigned int uiInst, CANCTRL_DUALFILTER_T* ptFilter )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_EnterListenMode)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_INVAL_PARAM                                               */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_LeaveListenMode)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_EnterSelftestMode)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_LeaveSelftestMode)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SendMessage)( unsigned int uiInst, CANCTRL_MESSAGE_T* ptMessage, bool fSingleShot, bool fSelfRx )
{
  uint32_t  ulCmd;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_AbortMessage)( unsigned int uiInst )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_ReceiveMessage)( unsigned int uiInst, CANCTRL_MESSAGE_T* ptMessage )
{
...
*   CANCTRL_RESULT_INVAL_PARAM                                               */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetIrqMask)( unsigned int uiInst, uint32_t ulIrqMask )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetWarningLimit)( unsigned int uiInst, uint32_t ulLimit )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetRxErrorCnt)( unsigned int uiInst, uint32_t ulCnt )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_RESULT_WRONG_MODE                                                */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetTxErrorCnt)( unsigned int uiInst, uint32_t ulCnt )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_SetPrm)( unsigned int uiInst, CANCTRL_PRM_E ePrmID, uint32_t ulPrmVal )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
...
*   CANCTRL_ERR_INVAL_PARAM                                           */
/*****************************************************************************/
CANCTRL_RESULT HALDEF(CanCtrl_GetPrm)( unsigned int uiInst, CANCTRL_PRM_E ePrmID, uint32_t* pulPrmVal )
{
  if( uiInst >= HAL_CANCTRL_CNT )
    return CANCTRL_RESULT_INVAL_PARAM;
