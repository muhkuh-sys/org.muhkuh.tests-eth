#ifndef __HAL_RESOURCES_DEFINES_NETX10_H
#define __HAL_RESOURCES_DEFINES_NETX10_H

#include "regdef_netx10.h"
#include "common_func_netx10.h" /* used for function names */

#define NX_XC_TYPE_RPU      NX10_XC_TYPE_RPU
#define NX_XC_TYPE_TPU      NX10_XC_TYPE_TPU
#define NX_XC_TYPE_XPEC     NX10_XC_TYPE_XPEC
#define NX_XC_TYPE_RPEC     NX10_XC_TYPE_XPEC /* alias */

#define MSK_NX_XC_TYPE_RPU  MSK_NX10_XC_TYPE_RPU
#define MSK_NX_XC_TYPE_TPU  MSK_NX10_XC_TYPE_TPU
#define MSK_NX_XC_TYPE_XMAC MSK_NX10_XC_TYPE_XMAC
#define MSK_NX_XC_TYPE_XPEC MSK_NX10_XC_TYPE_XPEC
#define MSK_NX_XC_TYPE_RPEC MSK_NX10_XC_TYPE_XPEC /* alias */
#define MSK_NX_XC_TYPE_ALL  MSK_NX10_XC_TYPE_ALL
...
/*** XC loader ***/
typedef int(*NX10_PFN_XC_RESET)      (unsigned int uiPort, void* pvUser);
typedef int(*NX10_PFN_XC_LOAD)       (unsigned int uiPort, NX10_XC_TYPE_E eXcType, const unsigned long* pulXcPrg, void* pvUser);
typedef int(*NX10_PFN_XC_START)      (unsigned int uiPort, void* pvUser);
typedef int(*NX10_PFN_XC_START_UNITS)(unsigned int uiPort, unsigned int uiUnitVec, void* pvUser );
...
#define __USE_XC_LOADER_FUNC_START_UNITS static NX10_PFN_XC_START_UNITS pfnXcStartUnits = NX10_XC_StartUnits;
...
typedef struct NX10_XPEC_IRQ_REGISTERS_ARRAY_Ttag
{
  volatile unsigned long  aulIrq_xpec[1];
} NX10_XPEC_IRQ_REGISTERS_ARRAY_T;
#define __USE_XPEC_IRQ_REGS  static NX10_XPEC_IRQ_REGISTERS_ARRAY_T* s_ptXpecIrqRegs = (NX10_XPEC_IRQ_REGISTERS_ARRAY_T*) Addr_NX10_xpec_irq_registers;
...
#endif /* __HAL_RESOURCES_DEFINES_NETX10_H */
