...
void     HALDEC(DPM_CfgDpm)( unsigned int        uiInst,
                             DPM_MODE_E          eMode,
                             DPM_ENDIANESS_E     eEndianess,
                             DPM_ADDRRANGE_E     eAddrRange,
                             DPM_CFGWINADDRCFG_E eCfgWinAddrCfg );
void     HALDEC(DPM_SetCfg0x0)( unsigned int        uiInst,
                                DPM_MODE_E      eMode,
                                DPM_ENDIANESS_E eEndianess );
void     HALDEC(DPM_SetAddrRange)( unsigned int        uiInst,
                                   DPM_ADDRRANGE_E eAddrRange );
void     HALDEC(DPM_SetCfgWinAddrCfg)( unsigned int        uiInst,
                                       DPM_CFGWINADDRCFG_E eCfgWinAddrCfg );
void     HALDEC(DPM_GetCfgDpm)( unsigned int        uiInst,
                                uint32_t* pulCfg0x0,
                                uint32_t* pulAddrCfg );
int      HALDEC(DPM_CfgIf)( unsigned int   uiInst,
...
int      HALDEC(DPM_CfgTiming)( unsigned int uiInst,
                                unsigned int uTosa,
                                unsigned int uFilter,
                                unsigned int uTrds,
                                unsigned int uRdBurstEn );
int      HALDEC(DPM_CfgRdy)( unsigned int     uiInst,
                             DPM_RDYPOL_E    eRdypol,
                             DPM_RDYDRV_E    eRdyDrv,
                             DPM_RDYMODE_E   eRdyMode,
                             DPM_RDYTO_CFG_E eRdyToCfg );
void     HALDEC(DPM_CfgPio)( unsigned int     uiInst, uint32_t ulSelDPio, uint32_t ulSelMiscPio );
void     HALDEC(DPM_GetCfgPio)( unsigned int     uiInst, uint32_t* pulDPio, uint32_t* pulMiscPio );
void     HALDEC(DPM_CfgMisc)( unsigned int     uiInst, uint32_t ulMiscCfg, uint32_t ulIoMiscCfg );
void     HALDEC(DPM_GetCfgMisc)( unsigned int     uiInst, uint32_t* pulMiscCfg, uint32_t* pulIoMiscCfg );
int      HALDEC(DPM_CfgDpmWindow)( unsigned int     uiInst, unsigned int uWinNum, uint32_t uSize, uint32_t ulMapStartAddr, DPM_WINMAP_ALT_E eAltMapping );
int      HALDEC(DPM_SetCfgDpmWindow)( unsigned int     uiInst, unsigned int uWinNum, uint32_t ulSize, uint32_t ulMapStartAddr, DPM_WINMAP_ALT_E eAltMapping );
int      HALDEC(DPM_GetCfgDpmWindow)( unsigned int     uiInst, unsigned int uWinNum, uint32_t* pulWinEnd, uint32_t* pulWinMap );
int      HALDEC(DPM_SetupByteAccess)( unsigned int     uiInst, unsigned int uWinNum, bool fByteAccess );
int      HALDEC(DPM_SetupReadAhead)( unsigned int     uiInst, unsigned int uWinNum, bool fReadAhead );
int      HALDEC(DPM_SetupReadLatch)( unsigned int     uiInst, unsigned int uWinNum, bool fReadLatch );
void     HALDEC(DPM_GetStatusErr)( unsigned int     uiInst, uint32_t *pulStatErr, uint32_t *pulStatErrAddr );
void     HALDEC(DPM_ClearErr)( unsigned int     uiInst, uint32_t ulClearMask );
int      HALDEC(DPM_GetIrq)( unsigned int     uiInst, DPM_IRQ_STATUS_E eIrqType, uint32_t *pulIrq );
void     HALDEC(DPM_Reset)( unsigned int     uiInst );
void     HALDEC(DPM_SetSysSta)( unsigned int     uiInst, uint32_t uSysSta );
void     HALDEC(DPM_GetSysSta)( unsigned int     uiInst, uint32_t *pulSysSta, uint32_t *pulSysStaBigEnd16 );
void     HALDEC(DPM_GetNetxVersion)( unsigned int     uiInst, uint32_t *pulNetxVersion, uint32_t *pulNetxVersionBigEnd16 );
int      HALDEC(DPM_CfgTunnel)( unsigned int uiInst,
                                ...
                                unsigned int uBase );
int      HALDEC(DPM_ITBAddr)( unsigned int     uiInst, unsigned int uMap, unsigned int uBase );
void     HALDEC(DPM_SetResetRequest)( unsigned int     uiInst, uint8_t bResetKey );
uint8_t  HALDEC(DPM_GetResetRequest)( unsigned int     uiInst );
void     HALDEC(DPM_SetFwIrqRaw)( unsigned int     uiInst, uint32_t ulFwIrqRaw );
int      HALDEC(DPM_AddrCmp)( unsigned int     uiInst, DPM_ADDRCCMP_E eAddrCmpNr, DPM_ADDRCMPCODE_E eAddrCmpCode );
bool     HALDEC(DPM_IrqIsPending)( unsigned int     uiInst,unsigned int uIrqId);
int      HALDEC(DPM_SetParam)( unsigned int     uiInst, DPM_PRM_E ePrmID, uint32_t ulPrmVal );
uint32_t HALDEC(DPM_GetParam)( unsigned int     uiInst, DPM_PRM_E ePrmID );
