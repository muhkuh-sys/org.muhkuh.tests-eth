...
PADCTRL_RESULT_E HALDEF(PadCtrl_SetCfg)( const uint32_t* paulConfigTable, unsigned int uNumEntries )
{
  ...
  {
    ulRegIdx = paulConfigTable[uTableIndex] >> SRT_PADCTRL_CFG_PORT;
    ulRegVal = paulConfigTable[uTableIndex] &  MSK_PADCTRL_CFG_VAL;
...
*   uint32_t                                                                 */
/*****************************************************************************/
uint32_t HALDEF(PadCtrl_GetCfg)( PADCTRL_PORT_E  ePort )
{
...
*  PADCTRL_RESULT_E                                                          */
/*****************************************************************************/
PADCTRL_RESULT_E HALDEF(PadCtrl_SetPullEn)( PADCTRL_PORT_E ePort, bool fEn )
{
  uint32_t ulRegVal;
