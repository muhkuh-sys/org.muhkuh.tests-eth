...
void     HIF_IOCTRL_SetLine( unsigned int uOutRegNum, uint32_t ulVal );
uint32_t HIF_IOCTRL_GetLine( unsigned int uOutRegNum );
void     HIF_IOCTRL_SetOe( unsigned int uOeRegNum, uint32_t ulVal );
...
int      HIF_IOCTRL_SetParam( HIF_IOCTRL_PRM_E ePrmID, uint32_t ulPrmVal );
